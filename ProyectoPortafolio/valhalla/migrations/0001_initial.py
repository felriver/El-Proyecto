# Generated by Django 4.0.4 on 2023-05-13 19:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valhalla.category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='valhalla.cart')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valhalla.cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='valhalla.product')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='valhalla.customer'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
